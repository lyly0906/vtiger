...
class Users_Logout_Action extends Vtiger_Action_Controller {
	...
	function process(Vtiger_Request $request) {
		...
		$session_id = $_SESSION['session_token'];
		...
		//End
		//$post = array('token'=>$session_id,'reback'=>'http://www.vtiger.com/index.php');
		//$app = new AppException();
		//$rs = $app->urlopen('http://live.vtiger.com/outlogout.php',$post);
		header('Location: http://live.vtiger.com/outlogout.php?token='.$session_id.'&reback=http://www.vtiger.com/index.php');
		exit();
		if(!empty($logoutURL)) {
