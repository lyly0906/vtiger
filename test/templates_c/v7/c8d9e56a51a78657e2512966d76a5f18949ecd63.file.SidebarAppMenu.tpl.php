<?php /* Smarty version Smarty-3.1.7, created on 2017-06-21 02:04:26
         compiled from "D:\programs\phpStudy\WWW\vtiger\includes\runtime/../../layouts/v7\modules\Vtiger\partials\SidebarAppMenu.tpl" */ ?>
<?php /*%%SmartyHeaderCode:168075940a55c09ab03-76072427%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'c8d9e56a51a78657e2512966d76a5f18949ecd63' => 
    array (
      0 => 'D:\\programs\\phpStudy\\WWW\\vtiger\\includes\\runtime/../../layouts/v7\\modules\\Vtiger\\partials\\SidebarAppMenu.tpl',
      1 => 1498010662,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '168075940a55c09ab03-76072427',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.7',
  'unifunc' => 'content_5940a55c13ad8',
  'variables' => 
  array (
...
<?php if ($_valid && !is_callable('content_5940a55c13ad8')) {function content_5940a55c13ad8($_smarty_tpl) {?>
...
<div class="app-menu hide" id="app-menu">
	<div class="container-fluid">
		...
		<div class="app-list row">
			<div class="menu-item app-item dropdown-toggle">
				<div class="menu-items-wrapper">
					<span class="app-icon-list fa fa-dashboard"></span>
					<span class="" id="showlhc">live helper chat</span>
					<script>
						$(function(){
							$('#showlhc').click(function(){
								$('#page').find('.main-container').html('');
								$('#page').find('.main-container').append('<OBJECT style="border: 0px;" type="text/x-scriptlet" data="http://live.vtiger.com/outlogin.php" width="100%" Height="1200px;" id="lhc"></OBJECT>');
								$('.tabContainer').html('');
								$('.tabContainer').append('<OBJECT style="border: 0px;" type="text/x-scriptlet" data="http://live.vtiger.com/outlogin.php" width="100%" Height="1200px;" id="lhc"></OBJECT>');
							});
							$("a[data-name=LBL_DEPA]").click(function(){
								$('#page').find('.main-container').html('');
								$('#page').find('.main-container').append('<OBJECT style="border: 0px;" type="text/x-scriptlet" data="http://live.vtiger.com/outlogin.php?reback=http://live.vtiger.com/index.php/site_admin/department/departments" width="100%" Height="1200px;" id="lhc"></OBJECT>');
							});
							//$('input[name=department]').parent().html();
							$('input[name=department]').click(function(){
								$('#depa').remove();
								$.ajax({
									type: "GET",
									url: "http://live.vtiger.com/index.php/restapi/departaments",
									dataType:"json",
									success: function(result) {
										var html = '';
										html = "<select id='depa' readOnly='true'>";
										html += "<option>选择部门</option>";
										$.each( result.list, function(index, content)
										{
											html += "<option value='"+content.name+"'>"+content.name+"</option>";
										});
										html +="</select>";
										$('input[name=department]').after(html);
										$("#depa").on("change",function(){
											$('input[name=department]').attr('value',$(this).attr('value'));
										});
									},
									beforeSend: function(xhr) {
										xhr.setRequestHeader("Authorization", "YWRtaW46Mzk3MTI2ODQ1bHk=");
									}
								});
							});
